		...
		if ( ! class_exists( 'Booking_Commerce' ) ) {
			...
			class Booking_Commerce {
				...
				public static function script() {
					$url=get_option( 'booking_link' );
					$result = "<script>(function() {var widget = document.createElement('script');widget.async = true;widget.src = '".$url."/widget/js/widget.js';widget.charset = 'UTF-8';widget.setAttribute('crossorigin', '*');widget.onload = function() {new beWidget({    'baseurl':'" . $url ."/en', 'brandColor': '#1747E3', 'widgetType': 'global'})};document.head.appendChild( widget );})();</script>";
					return $result;
				}
